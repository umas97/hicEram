...
- 🔒 **Privacy First (100% Offline)**: Nessun dato lascia il tuo dispositivo. Non ci sono server, nessun tracciamento in background. Le foto e i testi restano scritti nella memoria locale del tuo telefono, rendendo _Hic Eram_ il posto più sicuro per i tuoi ricordi.
...
2. Sotto "Assets", scarica il file `.apk`.
